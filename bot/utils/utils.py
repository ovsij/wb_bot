...
def get_difference(article, today, yesterday):
    ...
    print(f'today_page {today_page}')
    print(f'today_index {today_index}')
    print(f'yesterday_page {yesterday_page}')
    print(f'yesterday_index {yesterday_index}')
