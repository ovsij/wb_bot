...
def inline_kb_export():
    text = as_line(Bold('📑 Подключение Google таблиц.'),
                   ...
                   as_line('1. Откройте на компьютере или ноутбуке эту Google Таблицу 👉🏻', TextLink('WbConciergeBot v0.1', url='https://docs.google.com/spreadsheets/d/1_xSBNISb6Duovfy2bJRRgP1dJyTnpZKgZlpTyYOGDxc/edit?usp=sharing')),
